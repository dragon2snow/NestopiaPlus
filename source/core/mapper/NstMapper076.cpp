...
namespace Nes
{
	namespace Core
	{
		...
		{
			switch (const uint index = command)
			{
				case 0x2:
				case 0x3:
				case 0x4:
				case 0x5:
					...
					ppu.Update();
					chr.SwapBank<NES_2K>( (index - 0x2) << 11, data );
					break;

				case 0x6:
				case 0x7:

					prg.SwapBank<NES_8K>( (index == 0x6) ? (index & 0x40) ? 0x4000U : 0x0000U : 0x2000U, data );
					break;
			}
		}
	}
